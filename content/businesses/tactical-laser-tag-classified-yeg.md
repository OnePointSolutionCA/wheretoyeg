---
name: "Tactical Laser Tag Classified YEG"
slug: "tactical-laser-tag-classified-yeg"
category: "activities-fun"
subcategory: "laser-tag"
tier: "featured"
description: "Tactical Laser Tag Classified YEG — laser tag in Edmonton, Edmonton. 1015 Google reviews, 4.9★."
address: "13453 149 St, Edmonton, AB T5V 0B7"
...
reviews:
  ...
  - name: "Jameson Bucyk"
    rating: 5
    comment: |
      Best laser tag I've ever played by a country mile. The different hit zones between head & body are unique, and the guns are absolutely wicked with realistic weight, red/green dot scope, adjustable stock, gunfire sound effects, and a full reload function. The arena is awesome with solid variation and obstacles, and the different game modes keep each match intense in different ways. The highlight for me was the 'Sniper' game mode as it combines stealth with an emphasis on accuracy. Will absolutely be going back to play here again and have already recommended it to my friends as our private party had a great time blasting eachother to smithereens.
  - name: "Reagan Ochoco"
    rating: 5
    comment: |
  ...
  - name: "Vyn Banville"
    rating: 5
    comment: |
      The whole group had a blast, even those of us who were a little hesitant. I really like the variety of game modes! I’d definitely play again. Thanks for facilitating such a fun evening!
---
