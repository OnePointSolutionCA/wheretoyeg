...
tier: "featured"
description: "Niche Climbing — climbing in Edmonton, Edmonton. 161 Google reviews, 4.9★."
address: "10340 71 Ave NW, Edmonton, AB T6E 0W8"
...
reviews:
  - name: "DFX"
    ...
    comment: |
      ...
      They also have a good selection of snacks, drinks, and all types of climbing items for sale.
      
      The route is graded with numbers ranging from 1 to 8, I find 6 is similar to V5-6.
  ...
  - name: "Daniel Tran"
    ...
    comment: |
      ...
      The facility is always clean, and they have great amenities like foot washing stations and a private shower. It's also great to see new holds being purchased and used on the walls to change things up. Different parts of the gym are reset two times a week to provide a fresh climbing experience whenever you go back!
  ...
  - name: "Kine Patty"
    ...
    comment: |
      ...
      The set routes were pretty fun! Less dynamic/ competition style but still super fun.
