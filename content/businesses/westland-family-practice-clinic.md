...
tier: "featured"
phone: "(780) 962-9393"
google_maps: "https://maps.google.com/?cid=13677681608316434659&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA"
reviews:
  - name: "Carly Carly"
    rating: 5
    comment: |
      I’ve been going to this doctor’s office for years.
      
      Dr. Perry has delivered all four of my children, and she has been absolutely amazing every single time. She was there for each of my deliveries, and everything went so smoothly. You can truly tell how experienced she is—she always stays calm and never seems stressed, which made me feel so comfortable and confident in her care.
      
      She is also my family doctor, and any health concerns I’ve had have always been properly addressed with the right treatment.
  ...
  - name: "Roberto Alvarez-Amador"
    rating: 2
    comment: |
      I called on January 30 for a simple referral for a DEXA scan. This could have been done in 30 seconds over the phone. The receptionist (who was a little unprofessional over the phone) insisted that wasn't an option and said I'd have to come in person for the doctor to do any kind of paperwork. Instead I made an online appointment with TIA Health and got the referral after a couple minutes on the phone.
      
      Not sure if this is a policy the clinic has, or if the receptionist was just misinformed. I called the clinic first so my family doctor could bill for the visit. I can see where other reviewers are coming from with their criticism of the front staff, which is unfortunate because the doctors here are outstanding.
  - name: "K K"
    rating: 5
    comment: |
      Dr.Perry is amazing! She has been my family doctor for as long as I can remember. The front desk ladies are delightful in my opinion. I've never had a problem, always get my call answered, in a polite tone. Every time I go in for an appointment I've been greeted with a smile! ☆Ronda & Bernie are beautiful, inside & out☆
hours:
