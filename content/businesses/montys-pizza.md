...
reviews:
  ...
  - name: "Kevin Zentner"
    rating: 5
    comment: |
      Monty's is takeout only as far as I know, but it's probably the best iteration of Alberta-style pizza in existence. Toppings piled high, crispy, well-done crust, melty, crispy cheese on top.
      
      I remember calling and they would answer with my first name, asking how I am, and asking if I wanted to order the same thing as last time. Always polite and genuinely friendly when I pick up. This pizza reheats well the next day and is one of the most unique pizza shops in the city. Old school, thick pizza.
  - name: "Kelly Peters"
    rating: 5
    comment: |
