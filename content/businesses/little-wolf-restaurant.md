...
google_maps: "https://maps.google.com/?cid=4378770502320898999&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA"
photos:
...
reviews:
  - name: "Mike Kehl"
    rating: 5
    comment: |
      One of the highlights of my trip. Unique and interesting Japanese fusion food. Had the Curry Poutine and the Schnitzel (the two dishes everyone seems to recommend) and both were great. Schnitzel is huge, nicely breaded and perfectly cooked and it’s plays well the Japanese garnishes and condiments - truly enjoyable.
  - name: "Brett Williams"
    rating: 5
    comment: |
  ...
  - name: "Bryce"
    rating: 5
    comment: |
      This is a very cool little restaurant. Warm, friendly, and hip. The staff are friendly and welcoming, not performative. The smell of tobacco permeates the walls from the cigar shop next door and makes the restaurant smell so cozy and inviting.
