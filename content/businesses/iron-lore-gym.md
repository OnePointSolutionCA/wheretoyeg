...
google_maps: "https://maps.google.com/?cid=15791288718336527451&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA"
photos:
...
reviews:
  ...
  - name: "D J"
    rating: 5
    comment: |
      I’ve been going to Iron Lore Gym for a couple of years now, and even though I live way up on the north side of Edmonton, I still make the drive out to Beaumont once a week because this place is that special to me. Right from the first time I walked in, I knew it was the kind of gym I’d want to keep coming back to. The equipment selection is unreal—especially the pieces they’ve chosen for leg day. I’ve trained in a lot of different gyms over the years, but I’ve never found the same kind of machines and setup anywhere else.
      
      For me, Iron Lore has been about more than just physical progress. The private atmosphere has given me the space to push myself and grow mentally as well. It’s the kind of environment where you walk in and immediately feel focused and comfortable.
      
      Aaron and Eleni deserve a ton of credit for what they’ve built here. They care so much about the gym and the people who come through the doors. The space is always spotless, organized, and ready to go, but beyond that, they’ve created a community. The people who train here are supportive, respectful, and motivated, which makes a huge difference in your own training.
