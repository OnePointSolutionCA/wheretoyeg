...
tier: "featured"
phone: "(780) 462-6047"
website: "https://respirecoffee.ca/"
google_maps: "https://maps.google.com/?cid=14014368229102979014&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA"
photos:
  - "/images/businesses/respire-coffeehouse.jpg"
reviews:
  - name: "Julian Lengauer"
    rating: 5
    comment: |
      The Coffeehouse is adjacent to a chiropractor’s clinic (shared entrance) and it’s nice that clients could stop in for a coffee and treat after their session.
      We stopped by to check out a new place and were pleased by the kind service and quality food.
      Google Maps steered us to the neighbouring church to the west but we soon figured out which road entrance was actually correct.
      The seating area is larger than a typical coffee shop however it’s neat to imagine other events possible in the space as well. Will return next time we’re in the area, glad for the new experience.
  - name: "Sandra Loo"
    rating: 5
    comment: |
  ...
  - name: "Brad Faulkner"
    rating: 5
    comment: |
      Very cool hidden coffee shop in an Industrial area just off of 34 St & 76 Ave.  I decided to give this place a try as it's near where I work, and glad I did!
      
      I got the croissant sandwich & a guava fizz drink because it was a hot day out.  Both were delicious & refreshing!
      
      The prices I might add, are phenomenal, especially for an independent coffee shop.  These two items together cost me less than $10 (not counting added tip), and I definitely want to come back to try some other things.
      
      The atmosphere is very open, beautiful chairs & coaches, plenty of room for even when it's busy.  The service was phenomenal as well, my order took less than three minutes, and the lady was very nice.  Thank you so much for the great experience!
  - name: "Caesar"
    rating: 5
    comment: |
