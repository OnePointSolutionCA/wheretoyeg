...
subcategory: "burgers"
tier: "featured"
description: "Meat The Bun — burgers in West Edmonton, Edmonton. 65 Google reviews, 4.8★."
address: "9919 170 St NW, Edmonton, AB T5P 4S2"
...
reviews:
  ...
  - name: "Rocky Singh"
    rating: 5
    comment: |
      Amazing experience today! Great burgers smashed fresh to order! Hot food and not from under the heat lamp like in most fast food places! Had the Queen burger and cherry cheesecake milkshake! Outstanding quality and reasonably priced!!! Will be back for sure!!!
  - name: "Stephanie"
    rating: 5
    comment: |
      10/10 the best burger I’ve ever had! The chorizo hot dog was absolutely delicious, the fries were perfect, and the service was excellent. The restaurant itself is beautiful and has a great atmosphere. I highly recommend it, and I will definitely be coming back!
  - name: "Annie Poirier"
    rating: 5
    comment: |
