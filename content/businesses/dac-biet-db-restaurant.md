---
name: "Dac Biet (DB) Restaurant"
slug: "dac-biet-db-restaurant"
category: "restaurants"
subcategory: "vietnamese"
tier: "featured"
description: "Dac Biet (DB) Restaurant — a vietnamese spot in Edmonton, Edmonton. 116 Google reviews, 4.8★."
address: "10734 142 St NW, Edmonton, AB T5N 2P7"
...
reviews:
  ...
  - name: "Nadia Clark"
    ...
    comment: |
      ...
      The atmosphere was stunning: bright, clean, modern, and so welcoming. It felt upscale while still being comfortable and relaxed.
  ...
  - name: "Ann Nguyen"
    ...
    comment: |
      ...
      The space is bright, spacious, and very comfortable. I really appreciated how the tables are arranged smartly, with enough room to move chairs comfortably while still having privacy for conversation.
      The menu is also very thoughtful, with English, Vietnamese, and Chinese options, which is great for Asian clients and visitors. The food feels authentic, with a strong Huế-style Vietnamese flavour. Overall, the food was very good. I wouldn’t say “wow,” but definitely solid, tasty, and worth coming back for.
  ...
  - name: "Alice T"
    ...
    comment: |
      ...
      The flavours here are truly authentic and balanced, everything was done exactly how it should be done, which is very important to my family. We dislike it when flavours are inauthentic (aka sweetened), but that wasn’t what we experienced here. We ordered Bánh Bột Lọc Trần, Bánh Ít Trần Tôm Thịt, Bún Bò Huế Giò Heo, Bánh Canh Đồ Biển, Bánh Canh Nam Phổ, Chè 3 Màu, and Cà Phê Chồn.
      
      Admittedly, we were so excited that for some of the food, we forgot to take pictures as we were already half way done eating by the time I remembered to take pictures😆 So some pictures may have less food than what was actually served.
      
      Also, the Chè 3 Màu is done right with coconut milk, not regular milk. That’s a key distinction for good chè 3 màu, and we have a connoisseur in our family that spoke highly of this dessert here compared to any other location in the city.
