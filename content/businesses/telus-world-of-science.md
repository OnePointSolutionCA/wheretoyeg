...
google_maps_url: "https://maps.google.com/?q=TELUS%20World%20of%20Science%20Edmonton%20Edmonton"
hours:
...
photos: ["/photos/telus-world-of-science-1.jpg", "/photos/telus-world-of-science-2.jpg", "/photos/telus-world-of-science-3.jpg"]
rating: 4.6
review_count: 5800
price_range: "$$"
amenities:
...
reviews:
  - name: "Sheena Rogers"
    ...
    comment: |
      ...
      Their IMAX and Ziegler Dome were also awesome. We watched a show on planets in the Ziegler Done - great for kids and preteens.
  ...
  - name: "Adrian Werner"
    ...
    comment: |
      ...
      Still lots of things in these areas for slightly older kids. Some things brought out the inner kid in me and I would have played for hours if they weren’t a bit too advanced to maintain my little one's interest.
  ...
  - name: "L"
    ...
    comment: |
      ...
      There are always changes, updates, and new things to see and do, which keeps it feeling fresh even after many visits. We personally prefer going during quieter times with fewer crowds. If crowds do not bother you, any time works well. If you do mind crowds, it is worth checking their busy times, as it can get extremely busy, chaotic, and very loud.
      
      The Zeidler Dome is always a hit, regardless of what is playing. Be sure to check the schedule in advance. Some shows are free to walk into, while others require tickets.
      
      The gift shop consistently has great items for both kids and adults, and the staff are always friendly, engaging, and fun.
  ...
  - name: "Lynette M"
    ...
    comment: |
      ...
      We enjoyed a couple shows in the Zeigler Dome. 🌌🦕 Explored the Solar systems display. The STEAM lab is great! The kids enjoyed constructing their own balancing paper crafts.
      
      Thanks Telus World of Science.
---
