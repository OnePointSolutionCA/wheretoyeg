...
slug: "escape-city-edmonton-2"
category: "activities-fun"
subcategory: "escape-rooms"
tier: "featured"
description: "Escape City Edmonton — escape rooms in Edmonton, Edmonton. 1068 Google reviews, 4.7★."
address: "5916 104 Street NW, Edmonton, AB T6H 2K3"
...
reviews:
  ...
  - name: "inside reviews"
    rating: 5
    comment: |
      Came here for my first escape room experience with some friends and was blown away (compared to the next couple ones we went to). The Woodsman was quite the challenge and is great for groups to split up to conquer. Very unique puzzles and surprises. The staff also played into the experience very well!
  - name: "Ashlynn"
    rating: 5
    comment: |
