...
google_maps_url: "https://maps.google.com/?q=Mr.%20Lube%20Edmonton%20Edmonton"
hours:
...
reviews:
  - name: "Bruce Mattia"
    rating: 5
    comment: |
      Had a slow leak and figured I could probably stretch it a few more days, but best to deal with these things sooner rather than later. You never really know how quickly a tire can go.
      
      Looked up the nearest shop and was a bit surprised, and honestly happy, to see Mr. Lube + Tires pop up. Website said no appointment needed, but I called anyway. Good thing I did, no tire service after 5:00 and they close at 6:00. Worth knowing ahead of time.
      
      Pulled in, no appointment needed just like they said. Solid crew on that day, everyone seemed to know their role, communicating with each other and moving things along efficiently. No standing around, just got it done, quick and hassle-free, exactly what you want when it’s something you just need handled and off your plate.
      
      And as a bonus, the pup got a cookie. Nice touch.
  - name: "Steven Stuart-Smith"
    rating: 5
    comment: |
  ...
  - name: "Peyten Appleman"
    rating: 1
    comment: |
      I took my vehicle here for service, and the very next day it started overheating. I brought it to a mechanic I trust, and he told me the thermostat had been closed. The only place that had touched my car beforehand was this Mr. Lube. The result? Nearly $2,000 in repairs to replace the entire thermostat assembly.
      
      Whether this was incompetence or carelessness, it cost me thousands of dollars. I trusted this shop with a routine service, and my vehicle came back with a major issue almost immediately afterward.
