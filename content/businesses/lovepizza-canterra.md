...
google_maps: "https://maps.google.com/?cid=9572852272137854273&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA"
photos:
...
reviews:
  ...
  - name: "K"
    rating: 1
    comment: |
      Ordered two pizzas from this location through the Skip app. Absolutely dumbfounded when they arrived. I simply ordered a Donairza and a Meatatarian — two traditional pizzas. The worker who made them somehow managed to screw up so badly that the “Donairza” came as basically just meat, bread and cheese, while the Meatatarian had all the Donairza toppings (onions, tomatoes, and donair sauce) dumped on it instead. How do you even manage to mix up two completely opposite pizzas like that? Absolutely ridiculous
  - name: "Amanda Rehman"
    rating: 1
    comment: |
