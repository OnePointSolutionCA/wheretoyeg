...
google_maps: "https://maps.google.com/?cid=4603609610432263300&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA"
photos:
...
reviews:
  - name: "Natasha Jones"
    rating: 1
    comment: |
      Very strange experience. We order from here all the time for delivery. Half of the things we order are vegan for the non-meat eaters in the group. On Friday (March 20th) around 5:30 pm we ordered our usual for everyone. The plant-based burger had a gross chicken wing put into the burger so the person eating it would bite into bones. It was really weird and just gross. Everything else seemed fine, but the whole group was so disgusted no one would eat anything else. Total waste of money. I tried to phone twice just to let the manager know someone there might be tampering with the food. I could never get through to anyone so I have to let them know through a review. None of the people in my group want to keep ordering from here which I think is a shame because it’s probably just one employee’s bad behavior.
  - name: "Nicky Caissie"
    rating: 5
    comment: |
      Ordered delivery soooo delicious tried some new stuff crust pizzas and the new chicken tenders, amazing!!!
  - name: "Andrea Mottram"
    rating: 5
    comment: |
      We ordered large cheese pizza, curly fries and they were delicious!! Very affordable also - the staff were also very friendly when we picked up the order 🙂 Best pizza 73 we went to, this deserves a high review
  - name: "Cailey Joshua"
    rating: 1
    comment: |
