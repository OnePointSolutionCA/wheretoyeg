---
name: "Divine Creations Catering Ltd."
slug: "divine-creations-catering-ltd"
category: "catering"
subcategory: "event-catering"
tier: "featured"
description: "Divine Creations Catering Ltd. — a event-catering spot in Edmonton, Edmonton. 69 Google reviews, 4.7★."
address: "14538 116 Ave NW, Edmonton, AB T5M 3E8"
...
reviews:
  ...
  - name: "Carolyn"
    ...
    comment: |
      ...
      While the response explains preparation standards, portioning practices, and internal checks, it does not change the actual experience we had at the event. The explanation about procedures is difficult to reconcile with the quality of the food that was served.
      
      Personally, I had one small square of an egg salad sandwich and a few olives. The egg salad sandwich was dry, tasteless, and unappetizing, and the olives were dry. Those were the only items I attempted to eat because nothing else looked appealing. Even the desert squares were dried out. I ended up going out later to get something else to eat.
      
      Reading a long response focused on defending processes rather than acknowledging the concerns raised is frustrating. If the food had truly been checked and confirmed to meet the standards described, it is hard to understand how it could have been sent out in the condition we experienced.
      
      It is entirely possible that others have had positive experiences with Divine Catering over the years, and that is good to hear. However, that was not the experience at this memorial gathering. In a situation as sensitive as a funeral reception, a sincere acknowledgment and apology would have gone much further than a lengthy explanation defending the quality of food that, unfortunately, was not present at this event.
