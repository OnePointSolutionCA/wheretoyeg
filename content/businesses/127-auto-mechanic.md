...
reviews:
  - name: "Aryaman Theregoda"
    rating: 1
    comment: |
      Had an inspection done here. They seemed to be buddies with the seller because they didn’t tell me about the screws in my wiper fluid box. Those screws held up a bumper that was installed after the fact, and they missed the rack and pinion that needed replacing (a 2000 dollar service). Overall these guys are pretty shady with that stuff, hopefully new management fixes this.
  - name: "Cheryl Moore"
    rating: 5
    comment: |
  ...
  - name: "Emily Froese"
    rating: 5
    comment: |
      I'm absolutely thrilled with my experience at 127 Auto Mechanic! The shop is incredibly clean and organized, which speaks volumes about the professionalism of the team. The mechanic was friendly, knowledgeable, and genuinely interested in getting my vehicles OPI done quickly and efficiently.
      
      The pricing is very affordable, communication is top-notch, and he kept me informed every step of the way. Even showed me where to go for the paper work I needed beforehand.
      
      I've found a new go-to mechanic shop! Highly recommend 127 Auto Mechanic to anyone looking for trustworthy, reliable, and affordable service.
  - name: "Tony Racic"
    rating: 5
    comment: |
