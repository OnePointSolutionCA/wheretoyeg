...
slug: "khan-kebabs-karahi-halal---authentic-pakistani-afghani-cuisi"
category: "restaurants"
subcategory: "afghan"
tier: "featured"
description: "Khan Kebabs & Karahi (Halal) - Authentic Pakistani & Afghani Cuisine Edmonton — afghan in Edmonton, Edmonton. Halal-certified. 2041 Google reviews, 4.6★."
...
reviews:
  - name: "Afiyah"
    rating: 5
    comment: |
      Fresh kebabs and selective dishes from the Pakistani, Afghani and middle Eastern cuisine. Service is attentive and fast, the Punjabi lady with amazing urdu accent is the best, I believe her name was Manpreet/Gurpreet (sorry) Clean booths and decently maintained washrooms. So glad for their upcoming location at Parson's Road soon, it will accessible for many... do try them you won't the disappointed!
  - name: "Francesca"
    rating: 5
    comment: |
  ...
  - name: "Hamd-E-Rabbee Abbasi"
    rating: 5
    comment: |
      The new location has really outdone itself compared to the old one. The atmosphere and the food were just on another level. Alhamdulillah, everything was so comforting and full of flavour. The KK Special Handi was easily my number 1 — nothing topped it. The white karahi was a solid second, followed by trio-platter and chapali kebab. They also had this new in-house dessert — forgot the name but it was so nostalgic, honestly hadn't tasted a flavour like that in a long time. Definitely coming back to try everything else on the menu!
  - name: "Oemar Rehmaan"
    rating: 2
    comment: |
      Service: This place is understaffed. The servers are nice but it took them 25 min to come to us to take our order.
