---
name: "GYMVMT Fitness Club - Westmount Mall"
slug: "gymvmt-fitness-club---westmount-mall"
category: "gyms-fitness"
subcategory: "gyms"
tier: "featured"
description: "GYMVMT Fitness Club - Westmount Mall — a gyms spot in Edmonton, Edmonton. 196 Google reviews, 4.2★."
address: "Westmount Shopping Centre, 111 Ave NW, Edmonton, AB T5M 3L5"
...
reviews:
  - name: "Brad Todd"
    ...
    date: "2026-06-22"
    comment: |
      I've been a member of this gym for quite a while, and I couldn't be happier with my experience.
      
      The central location is incredibly convenient and only minutes from my house, which makes it easy to stay consistent with my workouts.
      
      The equipment is always well maintained, clean, and in great working condition. It's also great to see that they're continually investing in the facility by adding new equipment and upgrading the gym.
      
      What really sets this place apart, though, is the staff. Every single team member is fantastic—friendly, approachable, professional, and always willing to help. They create a welcoming atmosphere that makes a world of difference and makes coming to the gym an enjoyable experience.
      
      I’d recommend GYMVYNT Westmount to anyone looking for a clean, well-equipped facility with outstanding customer service. Keep up the great work!
  - name: "Katie Robertson"
    rating: 1
    date: "2026-07-13"
    comment: |
      Paid for a full year upfront — which, oddly, they seemed reluctant to let me do. Now I understand why. Not a single piece of communication the entire year. No check-ins, no renewal reminder, nothing.
      
      Then, instead of a simple "your membership is expiring," they waited until after my membership lapsed and hit me with an invoice. I was actually planning to renew — but that move was so transparently manipulative it changed my mind. You didn't need to trick me. I was already a willing customer.
