...
reviews:
  - name: "Karan Munjal"
    ...
    date: "2026-04-21"
    comment: |
      HW Produce is my go-to place for fresh fruits and vegetables. The produce is always fresh, and the store is beautifully organized and very clean, which makes shopping a great experience every time. They offer a wide variety of products, so I can always find what I need.
  ...
  - name: "john gallant"
    ...
    date: "2022-10-02"
    comment: |
      This is our favorite place to shop for fruits and vegetables. They have a great selection and everything is well displayed and the staff is always very friendly and helpful and they always have time to answer questions. They'll let us know if it's Canadian or imported for those who would like to know and are willing to help you with your purchase if you are disabled. They always try to keep the shelves stocked and neatly displayed and even the managers are working with their staff and helping customers which is always a welcome sight. These guys go out of their way to make the customers happy and I appreciate that a lot. Sometimes they have really nice sale prices and if you buy a certain amount they usually give you a free gift which is always welcome. Keep up the good work.
  - name: "Laura Bolton"
    rating: 5
    date: "2026-06-05"
    comment: |
      Older store but we'll kept. Food is usually fresh and staff works hard to keep it nice and clean. They always say hello and are very polite. Couldn't ask for better!
  - name: "Kirk Dewhurst"
    rating: 5
    date: "2020-08-14"
    comment: |
