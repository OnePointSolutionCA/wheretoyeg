---
name: "Fred Broadstock Swimming Pool"
slug: "fred-broadstock-swimming-pool"
category: "gyms-fitness"
subcategory: "swimming"
tier: "featured"
description: "Fred Broadstock Swimming Pool — swimming in Edmonton, Edmonton. 477 Google reviews, 4.3★."
address: "15720 105 Ave NW, Edmonton, AB T5P 2Y6"
neighborhood: "Edmonton"
phone: "(780) 442-5311"
website: "http://www.edmonton.ca/activities_parks_recreation/fred-broadstock-outdoor-pool.aspx"
google_maps_url: "https://maps.google.com/?cid=18330015972682321562&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA"
hours:
...
reviews:
  - name: "Anna Z"
    rating: 5
    comment: |
      A great outdoor pool for both adults and kids! It gets very crowded on weekends, and parking is limited, so try to arrive early.
  ...
  - name: "Sailor Vee"
    rating: 5
    comment: |
      Very affordable! Staff are super friendly and chill, havent had any inconveniences or problems since I started swimming here this year with my daughter!
      Great pool temps and things are kept clean in the bathrooms/ showers!
      Lockers are accessible and only 25-50cents depending on the size you need.
      My daughter thinks the kids pool is cool n also a great temperature, She enjoys the easy access to the life jackets and water fountain (:
  ...
  - name: "Morgan M"
    rating: 1
    comment: |
      Came in on a Saturday at 4. Security was checking people in because stupid idiots got drunk at the pool earlier.
      The only lane swim is 8 to 9 am. Every other time is crawling with children. And the adults can't follow the rules of the pool, leaving me and my friend terrified when a women started taking pictures of the entire pool, and lifeguard staff were so busy with the other adult idiots that they couldn't do anything. It was chaos with the poor lifeguards trying to help this woman find one of her multiple children. If you can't handle 6 children don't bring 6 children.
      
      Every adult should sign a form consenting to following the rules and be immediately kicked out for breaking them.
