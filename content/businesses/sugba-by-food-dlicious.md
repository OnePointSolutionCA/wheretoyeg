---
name: "SUGBA by Food-D'Licious"
slug: "sugba-by-food-dlicious"
category: "restaurants"
subcategory: "filipino"
tier: "featured"
description: "SUGBA by Food-D'Licious — filipino in Edmonton, Edmonton. 144 Google reviews, 4.5★."
address: "8170 50 St NW #145, Edmonton, AB T6B 1E6"
...
reviews:
  ...
  - name: "Jean-Pierre Brossard"
    ...
    comment: |
      ...
      This restaurant is clearly a popular  place since it got crowded with people quick, I recommend to visit as soon as they open if you are coming to try the buffet.
      
      I’ve been to Philippines many times to be able to taste the difference. Must say the food I had here was pretty average, it didn’t taste like local Filipino food…
      
      Chicken Inasal was good but the Lechon was on a sweeter side than it supposed to be and the pork skin was not that crunchy.
  ...
  - name: "Vinze"
    ...
    comment: |
      ...
      Food was hot all through out the event and very accomodating staff. Everyone was really excited and really want to help out on our event.
      
      Their options for dishes will mostly have options for everyone that might have issues or allergies. So one less thing to worry for your guest!!
      
      We had: Pork Sisig, Beef Kare kare, No meat chopsuey, Sweet and Sour Fish, Chicken Pancit Mix. And as for desserts Mix kakanin and cheesecake.
      
      It is really surprising that the cheesecakes have a variety of flavors (I only remember ube and strawberry)
      
      If anyone is interested below are the details :)
