---
name: "Albany Chiropractic Physiotherapy & Massage"
slug: "albany-chiropractic-physiotherapy-massage"
category: "medical"
subcategory: "chiropractors"
tier: "featured"
description: "Albany Chiropractic Physiotherapy & Massage — a popular chiropractors spot in Edmonton, Edmonton. 330 Google reviews, 4.9★."
address: "12764 167 Ave NW, Edmonton, AB T6V 1J6"
...
reviews:
  ...
  - name: "Pamela Marchant"
    ...
    date: "2026-06-20"
    comment: |
      I highly recommend Dr. Awad for any Chiropractic needs you may have. The clinic is clean and comfortable, and the staff are friendly and helpful. Dr. Awad is knowledgeable and personable. He explains everything well and answers questions and gives suggestions to help your overall health.
  - name: "Mother May I"
    rating: 5
    date: "2026-04-28"
    comment: |
      Some of us hesitate about chiro, but you're in really good hands here, pun intended. My neck was so tight it started affecting my shoulder and trickled down. Not only did Dr Awad take the time to tell me where all the tensions are, he made sure I was completely relaxed to respond well to the adjustment. He's also helped out my sister with a bad case of vertigo when no one else in Edmonton could. Will be back, thanks for having such a great clinic!
  - name: "Chris Thompson"
    rating: 5
    date: "2026-06-08"
    comment: |
