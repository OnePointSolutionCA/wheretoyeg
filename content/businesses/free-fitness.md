...
subcategory: "gyms"
tier: "featured"
description: "F.R.E.E. Fitness — a gyms spot in Edmonton, Edmonton. 388 Google reviews, 5.0★."
address: "11507 120 St NW #105, Edmonton, AB T5G 2Y4"
...
reviews:
  - name: "Chris Cottingham"
    rating: 5
    date: "2026-03-02"
    comment: |
      F.R.E.E. Fitness is a special place that has cultivated an environment rich in community. All of their equipment is top notch, but the trainers that work here have played a huge role in my choice to stay a member and continuing to train here: everyone genuinely cares about their clients and wants to see them succeed. I came to F.R.E.E. Fitness unfamiliar with gym equipment and uncomfortable with gyms due to my lack of experience with working out. In large part due to my trainer Max and others that work at the gym, I now feel confident and capable in the gym and am in the best shape of my life. Whether you are looking for a new gym, or are considering going to the gym for the first time in your life like I was 6 months ago, I would highly recommend coming to F.R.E.E. Fitness. You will not be disappointed.
  - name: "Clara Mtsigwah"
    rating: 5
    date: "2026-06-12"
    comment: |
      Best thing about this gym is the atmosphere. Everyone is welcoming and very helpful. Trainers are great and thanks to Tony and staff for creating such safe, welcoming space.  Highly recommend it!
  - name: "Jeremiah Kim"
    rating: 5
    date: "2026-02-28"
    comment: |
      Exceptional Rehabilitation Team
      
      Recovering from a complete patellar tear is a significant challenge, but this team has made the process seamless.
