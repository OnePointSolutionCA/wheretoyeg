...
reviews:
  - name: "Nimo Isxaaq"
    rating: 5
    comment: |
      Excellent selection of All Beauty products. Clean store and price affordable and good customer service. Highly recommend.
  - name: "Pavi K Pavan"
    rating: 5
    comment: |
  ...
  - name: "Narang Toor"
    rating: 5
    comment: |
      This is excellent grocery store with a great selection of Indian products, fresh vegetables,spices,frozen foods and snacks. The store is always clean,well organised and the staff are friendly, helpful and welcoming.
  - name: "Jaskirat Singh"
    rating: 1
    comment: |
