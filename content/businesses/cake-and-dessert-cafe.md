...
google_maps: "https://maps.google.com/?cid=9366220889194662694&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA"
photos:
  - "/images/businesses/cake-and-dessert-cafe.jpg"
reviews:
  - name: "Jay Boots"
    rating: 4
    comment: |
      Food was pricey. Grateful as they are open later hours, everything tasted okay. The shaved ice with the strawberry topping tasted overly sweet, it would have been nicer with less syrup. Drinks are gorgeous so if you want an aesthetic spot this place is it. Lots of seating if you want a cozy spot to catch up with a friend.
  - name: "Ailyn Sambrano"
    rating: 5
    comment: |
      The Honey Bread is seriously amazing!!
      Also, the service here is top notch. She went out of her way to make our visit memorable, even if we asked for take out! She was super nice and friendly as well! Definitely recommend coming here.
  - name: "carat*iz"
    rating: 3
    comment: |
  ...
  - name: "Nelya"
    rating: 5
    comment: |
      Don’t let the outside fool you—it looks a bit abandoned around the café, but inside it’s cozy, the food is delicious, and the girl behind the counter is incredibly warm and sweet. I highly recommend the Honey Bread! The drinks are fantastic, and everything else on the menu is just as amazing.
hours:
